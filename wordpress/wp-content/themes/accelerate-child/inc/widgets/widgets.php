...
function accelerate_widgets_init() {
	...
	// Registering Fees Page template top section sidebar
	register_sidebar( array(
		'name' 				=> __( 'Fees Sidebar', 'accelerate' ),
		'id' 					=> 'accelerate_fees_sidebar',
		'description'   	=> __( 'Shows widgets on Fees Page Template.', 'accelerate' ),
		'before_widget' 	=> '<section id="%1$s" class="widget %2$s clearfix">',
		'after_widget'  	=> '</section>',
		'before_title'  	=> '<h3 class="widget-title">',
		'after_title'   	=> '</h3>'
