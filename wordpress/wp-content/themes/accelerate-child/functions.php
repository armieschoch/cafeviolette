...
//Change Howdy user to Welcome in the admin page
...
//Remove Lost your password text on login page
...
//Redirect non-admin users to site home Page
...
//Removing the shaking action when user enter the incorrect login information
...
function my_login_logo() { ?>
    <style type="text/css">
        #login h1 a, .login h1 a {
            background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/chasc_logo.png);
		height:150px;
		width:320px;
