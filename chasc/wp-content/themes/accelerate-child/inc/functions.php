...
function accelerate_footer_copyright() {
	...
	$wp_link = '<a href="'.esc_url( 'http://restwebsolutions.com' ).'" target="_blank" title="' . esc_attr__( 'Rest web Solutions', 'chasc' ) . '"><span>' . __( 'Rest web Solutions', 'chasc' ) . '</span></a>';
	...
	$default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s.', 'chasc' ), date( 'Y' ), $site_link ).' '.sprintf( __( 'Powered by %s.', 'chasc' ), $wp_link );
